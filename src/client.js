  ...
  window.sendAiMessage = async function() {
    ...
    try {
      ...
      var systemPrompt = "You are an AI Agent for Site24x7 APIs. The user wants to perform an action.\n" +
        ...
        contextStr + "\n\n" +
        "Instructions:\n" +
        "1. Identify the correct API to use based on the context OR the previous conversation.\n" +
        ...
        "If the user is asking to modify or update the previous payload, simply output the updated JSON object for the same endpoint.\n" +
